...
# Import components
try:
    from src.utils.destination_parser import SmartDestinationManager
...
class DemoDataManager:
    ...
    def get_destination_info(
        ...
        if self.smart_parser:
            ...
            # Parse destination with smart parser (LLM + geocoding)
    ...
    def _fetch_experiences_and_tours(
        ...
        """
        : Fetch diverse experiences and tours
        ...
        try:
            ...
            # More diverse search queries to get different types
            search_queries = [
                # Tours (5)
    ...
    # Fallback IATA mapping for common cities if smart parser fails or is unavailable
